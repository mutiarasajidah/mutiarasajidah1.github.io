...
<head>
    ...
    <style>
        ...
        header {
            ...
            margin: 20px;
            border-radius: none; /* Menambahkan lengkungan pada header */
        }
        ...
        nav {
            ...
            padding: 10px;
            margin: 20px;
            border-radius:none; /* Menambahkan lengkungan pada nav */
            border:none; /* Menambahkan border pada nav */
        }
        ...
        main {
            ...
            text-align: center;
            margin: 20px;
            border-radius: none; /* Menambahkan lengkungan pada main */
            border: none; /* Menambahkan border pada main */
        }

        #featured-products {
            border: none;
            border-radius: none; /* Menambahkan lengkungan pada featured-products */
            padding: 20px;
            margin-bottom: 20px;
        ...
        .card {
            ...
            border-radius: 15px; /* Menambahkan lengkungan pada card */
            overflow: hidden;
        ...
        .card img {
            ...
            display: block;
            margin: 10px auto;
            border-radius: 15px; /* Menambahkan lengkungan pada gambar dalam card */
        }
        ...
        .btn {
            ...
            padding: 10px 20px;
            border: none;
            border-radius: none; /* Menambahkan lengkungan pada tombol */
            text-decoration: none;
        ...
        footer {
            ...
            padding: 10px;
            margin: 20px;
            border-radius: none; /* Menambahkan lengkungan pada footer */
        }
    </style>
</head>
<body>
...
<p>Telepon: (08)96-6187-81000 | Email: guitar_world@gmail.com</p></center>
    </div>
    <nav>
        <ul>
            ...
            <div class="products">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Gitar ini merupakan salah satu gitar paing laris di Guitar World.</p>
